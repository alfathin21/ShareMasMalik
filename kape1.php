...
function Header()
{
	...
	$this->Ln(3);
		...
		$this->Cell(0,5,'GA A330                         TECHNICAL DELAY > 15 MINUTES AND CANCELLATIONS','TLBR',1,'C');
...
$pdf->SetFont('Times','',8);
	...
	//Baris ke-1
  $pdf->Ln();
	$pdf->Cell(45,4,'REVENUE TAKE OFFS','TBLR',0,'C');
	$pdf->Cell(9,4,'478','TBLR',0,'C');
	$pdf->Cell(9,4,'437','TBLR',0,'C');
	$pdf->Cell(9,4,'467','TBLR',0,'C');
	$pdf->Cell(11,4,'1382','TBLR',0,'C');
	$pdf->Cell(14,4,'5135','TBLR',0,'C');
