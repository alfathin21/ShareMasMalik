...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1128 class=xl379746
 ...
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td class=xl349746 colspan=2>PILOT REPORT</td>
  <td class=xl339746>&nbsp;</td>
 ...
 <tr height=21 style='mso-height-source:userset;height:15.95pt'>
  ...
  <td class=xl499746 x:num><?=  $ATApirep[$bulan[2]][$ATA[$i]]?></td>
  <td class=xl499746 style='border-left:none' x:num><?=  $ATApirep[$bulan[1]][$ATA[$i]]?></td>
  <td class=xl499746 style='border-left:none' x:num><?=  $ATApirep[$bulan[0]][$ATA[$i]]?></td>
  <td class=xl499746 x:num><?=  $ATApirep[$bulan[0]][$ATA[$i]] + $ATApirep[$bulan[1]][$ATA[$i]] + $ATApirep[$bulan[2]][$ATA[$i]]?></td>
  <td class=xibny2 x:num><?=  $ATA12bulan[$ATA[$i]]?></td>
  ...
  <td class=xl559746 x:num><?=  round($alertlevel[$ATA[$i]],2)?></td>
