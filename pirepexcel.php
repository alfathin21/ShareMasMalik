...
?>
 <tr height=3 style='mso-height-source:userset;height:12.75pt'>
  <td height=3 class=xl374199 style='height:12.75pt;border-top:none'>B737-Classic</td>
   <?php 
		foreach ($bulan as $key => $value){
			$totalpirepclassic = 0;
			foreach ($acclassic as $k => $v){
				$totalpirepclassic += $ATA[$v][$value];
			}
  ?>
  <td class=xl354199 style='border-top:none;border-left:none'><?= $totalpirepclassic?></td>
	<?php 
		}
  ?>
  <td class=xl324199></td>
...
?>
 <tr height=3 style='mso-height-source:userset;height:12.75pt'>
  <td height=3 class=xl374199 style='height:12.75pt;border-top:none'>B737-Classic</td>
   <?php 
		foreach ($bulan as $key => $value){
			$totalACinServclassic = 0;
			$totalAvailclassic = 0;
			foreach ($acclassic as $k => $v){
				$totalAvailclassic += $available[$v][$value];
			}
			$totalACinServclassic = round($totalAvailclassic/jumlahbulan($value),2);
  ?>
  <td class=xl354199 style='border-top:none;border-left:none'><?= $totalACinServclassic?></td>
	<?php 
		}
  ?>
  <td class=xl324199></td>
...
?>
 <tr height=17 style='height:12.75pt'>
  <td height=17 class=xl374199 style='height:12.75pt;border-top:none'><?= $v?></td>
	...
	$i = 0;
	foreach ($bulan as $key => $value){
	$i++;$formula = ($acinservice[$v][$value] <> 0) ? "=ROUND((".chr(65 + $i).($j + 4)."/".chr(65 + $i).($j + 21)."),2)" : 0;
	?>
 ...
 <tr height=3 style='mso-height-source:userset;height:12.75pt'>
  <td height=3 class=xl374199 style='height:12.75pt;border-top:none'>B737-Classic</td>
   <?php 
		$i = 0;
		foreach ($bulan as $key => $value){
			$i++;$formula = "=ROUND((".chr(65 + $i).($j + 4)."/".chr(65 + $i).($j + 21)."),2)";
  ?>
  <td class=xl334199 style='border-top:none' x:num x:fmla=<?= $formula?>></td>
	<?php 
		}
