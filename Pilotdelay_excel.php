...
?>
 ...
 <tr height=21 style='mso-height-source:userset;height:15.95pt'>
  ...
  <td class=xl778756>LAST 3</td>
  <td class=xl568756>12 Months</td>
  <td class=xl438756 x:fmla="=C62"><?=  bulan($bulan[2])?></td>
  <td class=xl438756 x:fmla="=D62"><?=  bulan($bulan[2])?></td>
  <td class=xl438756 x:fmla="=E62"><?=  bulan($bulan[2])?></td>
  <td class=xl778756>3 Months</td>
  <td class=xl568756>12 Months</td>
 ...
 <tr height=21 style='mso-height-source:userset;height:15.95pt'>
  ...
  <td class=xl968756 x:num x:fmla="=C<?=  (65 + $i)?>*100/$C$62"></td>
  <td class=xl968756 x:num x:fmla="=D<?=  (65 + $i)?>*100/$D$62"></td>
  <td class=xl968756 x:num x:fmla="=E<?=  (65 + $i)?>*100/$E$62"></td>
  <td class=xl968756 x:num x:fmla="=F<?=  (65 + $i)?>*100/$F$62"></td>
