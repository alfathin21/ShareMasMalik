...
?>
 ...
 <tr height=17 style='height:12.75pt'>
  <td colspan=2 height=17 class=xl604208 style='border-right:1.0pt solid black;
  height:12.75pt'>BASIC PLANNED</td>
  <td class=xl534208 style='border-left:none;border-left:none' x:num><?= $engineremovallastyear["Basic Planned"]?></td>
<?php
	foreach ($bulan as $key => $value){
?>
  <td class=xl294208 style='border-top:none;border-left:none' x:num><?= $engineremoval["Basic Planned"][$value]?></td>
<?php
  }
?>
 ...
 <tr height=18 style='height:13.5pt'>
  ...
  border-bottom:.5pt solid black;height:13.5pt'>        UNPLANNED</td>
  <td class=xl534208 style='border-left:none' x:num><?= $engineremovallastyear["Basic UnPlanned"]?></td>
<?php
	foreach ($bulan as $key => $value){
?>
  <td class=xl294208 style='border-top:none;border-left:none' x:num><?= $engineremoval["Basic UnPlanned"][$value]?></td>
<?php
  }
?>
  <!--<td class=xl294208 style='border-top:none;border-left:none' x:num>0</td>
 ...
 <tr height=18 style='height:13.5pt'>
  <td colspan=2 height=18 class=xl704208 style='border-right:1.0pt solid black;
  border-bottom:.5pt solid black;height:13.5pt'>NON BASIC PLANNED</td>
  <td class=xl534208 style='border-left:none' x:num><?= $engineremovallastyear["Non Basic Planned"]?></td>
<?php
	foreach ($bulan as $key => $value){
?>
  <td class=xl294208 style='border-top:none;border-left:none' x:num><?= $engineremoval["Non Basic Planned"][$value]?></td>
<?php
  }
?>
  <!--<td class=xl294208 style='border-top:none;border-left:none' x:num>0</td>
 ...
 <tr height=18 style='height:13.5pt'>
  <td colspan=2 height=18 class=xl704208 style='border-right:1.0pt solid black;
  border-bottom:.5pt solid black;height:13.5pt'>        UNPLANNED</td>
  <td class=xl534208 style='border-left:none' x:num><?= $engineremovallastyear["Non Basic UnPlanned"]?></td>
<?php
	foreach ($bulan as $key => $value){
?>
  <td class=xl294208 style='border-top:none;border-left:none' x:num><?= $engineremoval["Non Basic UnPlanned"][$value]?></td>
<?php
  }
?>
  <!--<td class=xl294208 style='border-top:none;border-left:none' x:num>0</td>
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl334208 style='border-top:none;border-left:none' x:num><?= ($engineremovallastyear["Non Basic UnPlanned"] + $engineremovallastyear["Basic UnPlanned"])?></td>

<?php
	foreach ($bulan as $key => $value){
?>
  <td class=xl344208 style='border-top:none;border-left:none' x:num><?= ($engineremoval["Basic UnPlanned"][$value] + $engineremoval["Non Basic UnPlanned"][$value])?></td>
<?php
}
?>
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  x:num><?= (array_sum($FHlastyear) <> 0) ? round(($engineremovallastyear["Non Basic UnPlanned"] + $engineremovallastyear["Basic UnPlanned"])/(array_sum($FHlastyear) * $numberofengine)*1000,3) : ""?></td>
<?php
	foreach ($bulan as $key => $value){
?>
  <td class=xl434208 style='border-top:none;border-left:none' x:num><?= (!empty($FH[$value]) ? round((($engineremoval["Basic UnPlanned"][$value] + $engineremoval["NonBasic UnPlanned"][$value])/($FH[$value] * $numberofengine)*1000),3) : 0)?></td>
<?php
  }
?>
  <!--<td class=xl434208 style='border-top:none;border-left:none' x:num>0.000</td>
...
?>
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  VISITS</td>
  <td class=xl374208 style='border-top:none' x:num><?= $SVlastdata?></td>
<?php
	foreach ($bulan as $key => $value){
?>
  <td class=xl354208 style='border-top:none;border-left:none' x:num><?= $SV[$value]?></td>
<?php
  }
?>
  <td class=xl244208></td>
 ...
 <tr height=15 style='mso-height-source:userset;height:11.25pt'>
  ...
  x:num><?= (array_sum($FHlastyear) <> 0) ? round((($SVlastdata)/(array_sum($FHlastyear)*$numberofengine)*1000),3) : ""?></td>
<?php
	foreach ($bulan as $key => $value){
?>
  <td class=xl454208 style='border-top:none;border-left:none' x:num><?= (!empty($FH[$value]) ? round((($SV[$value])/($FH[$value] * $numberofengine)*1000),3) : 0)?></td>
<?php
  }
?>
  <td class=xl244208></td>
...
<?php
	foreach ($bulan as $key => $value){
?>
  <td class=xl434208 style='border-top:none;border-left:none' x:num><?= (!empty($FH24[$bulan12[$key+10]]) ? round((($SV[$bulan12[$key+10]] + $SV[$bulan12[$key+11]] +  $SV[$bulan12[$key+12]])/(($FH24[$bulan12[$key+10]] + $FH24[$bulan12[$key+11]] + $FH24[$bulan12[$key+12]]) * $numberofengine)*1000),3) : 0)?></td>
<?php
  }
?>
  <td class=xl244208></td>
  ...
  <tr height=17 style='height:12.75pt'>
  <td height=17 class=xl604208 style='height:12.75pt;border-top:none'>&nbsp;</td>
  <td class=xl614208 style='border-top:none' x:str="' - 12 MO. RATE"><span
  style='mso-spacerun:yes'> </span>- 12 MO. RATE</td>
  <td class=xl514208 style='border-top:none;border-left:none'>&nbsp;</td>
<?php
	foreach ($bulan as $key => $value){
?>
  <td class=xl434208 style='border-top:none;border-left:none' x:num><?= (!empty($FH24[$bulan12[$key+1]]) ? round((($SV[$bulan12[$key+1]] + $SV[$bulan12[$key+2]] +  $SV[$bulan12[$key+3]] + $SV[$bulan12[$key+4]] + $SV[$bulan12[$key+5]] +  $SV[$bulan12[$key+6]] + $SV[$bulan12[$key+7]] + $SV[$bulan12[$key+8]] +  $SV[$bulan12[$key+9]] + $SV[$bulan12[$key+10]] + $SV[$bulan12[$key+11]] +  $SV[$bulan12[$key+12]])/(($FH24[$bulan12[$key+1]] + $FH24[$bulan12[$key+2]] + $FH24[$bulan12[$key+3]] + $FH24[$bulan12[$key+4]] + $FH24[$bulan12[$key+5]] + $FH24[$bulan12[$key+6]] + $FH24[$bulan12[$key+7]] + $FH24[$bulan12[$key+8]] + $FH24[$bulan12[$key+9]] + $FH24[$bulan12[$key+10]] + $FH24[$bulan12[$key+11]] + $FH24[$bulan12[$key+12]]) * $numberofengine)*1000),3) : 0)?></td>
<?php
  }
?>
  <td class=xl244208></td>
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl374208 style='border-top:none;border-left:none' x:num><?= ($engineremovallastyear["Basic Planned"] + $engineremovallastyear["Basic UnPlanned"] + $engineremovallastyear["Non Basic Planned"] + $engineremovallastyear["Non Basic UnPlanned"])?></td>
<?php
	foreach ($bulan as $key => $value){
?>
  <td class=xl354208 style='border-top:none;border-left:none' x:num><?= ($engineremoval["Basic Planned"][$value] + $engineremoval["Basic UnPlanned"][$value] + $engineremoval["Non Basic Planned"][$value] + $engineremoval["Non Basic UnPlanned"][$value])?></td>
<?php
  }
?>
  <td class=xl244208></td>
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl564208 style='border-top:none;border-left:none' x:num><?= (array_sum($FHlastyear) <> 0) ? round((($engineremovallastyear["Basic Planned"] + $engineremovallastyear["Basic UnPlanned"] + $engineremovallastyear["Non Basic Planned"] + $engineremovallastyear["Non Basic UnPlanned"])/(array_sum($FHlastyear)*$numberofengine)*1000),3) : ""?></td>
<?php
	foreach ($bulan as $key => $value){
?>
  <td class=xl454208 style='border-top:none;border-left:none' x:num><?= (!empty($FH[$value]) ? round((($engineremoval["Basic Planned"][$value] + $engineremoval["Basic UnPlanned"][$value] + $engineremoval["Non Basic Planned"][$value] + $engineremoval["Non Basic UnPlanned"][$value])/($FH[$value] * $numberofengine)*1000),3) : 0)?></td>
<?php
  }
?>
  <td class=xl244208></td>
