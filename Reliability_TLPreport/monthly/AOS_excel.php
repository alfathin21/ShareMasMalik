...
<table x:str border=0 cellpadding=0 cellspacing=0 width=969 class=xl351976
 ...
 <tr height=22 style='mso-height-source:userset;height:16.5pt'>
  ...
  height:16.5pt' x:str="BOEING 737-500 ">BOEING <?= $actype?><span
 ...
 <tr height=23 style='mso-height-source:userset;height:17.45pt'>
  ...
  <td colspan=12 class=xl411976>2007 - 2008</td>
 ...
 <tr height=23 style='mso-height-source:userset;height:17.45pt'>
  ...
  <?php
		foreach ($bulan as $key => $value){
	?>
  <td class=xl491976 x:num><?= $fleet[$value]?></td>
  <?php
		}
   ?>
  <td class=xl501976 x:num x:fmla="=SUM(C5:N5)/11"></td>
 </tr>
 <tr height=23 style='mso-height-source:userset;height:17.45pt'>
  ...
  <td class=xl511976 x:num><?= round($available[$value]/jumlahbulan($value),2)?></td>
   ...
   ?>
  <td class=xl521976 x:fmla="=SUM(O7/O33)"></td>
 </tr>
 <tr height=23 style='mso-height-source:userset;height:17.45pt'>
  ...
  <?php
		foreach ($bulan as $key => $value){
  ?>
  <td class=xl491976 x:num><?= $available[$value]?></td>
   <?php
		}
   ?>
 ...
 <tr height=23 style='mso-height-source:userset;height:17.45pt'>
  ...
  <?php
		foreach ($bulan as $key => $value){
  ?>
  <td class=xl491976 x:num><?= $FH[$value]?></td>
  <?php
		}
   ?>
...
<?php
		foreach ($bulan as $key => $value){
  ?>
  <td class=xl491976 x:num><?= $FC[$value]?></td>
  <?php
		}
   ?> 
...
<?php
 ...
 <tr height=23 style='mso-height-source:userset;height:17.45pt'>
  ...
  Offs-Total(*)</td>
  <td class=xl621976><?= (round(array_sum($FHlastyear)/array_sum($FClastyear),0))." : ".(round(((array_sum($FHlastyear)/array_sum($FClastyear))-round(array_sum($FHlastyear)/array_sum($FClastyear),0))*60,0))?></td>
  <?php
		foreach ($bulan as $key => $value){
  ?>
  <td class=xl631976 style='border-top:none' x:str><?= (round($FH[$value]/$FC[$value],0))." : ".abs(round((($FH[$value]/$FC[$value])-round($FH[$value]/$FC[$value],0))*60,0))?></td>
  <?php
		}
   ?>   
  <td class=xl521976><?= (round(array_sum($FH)/array_sum($FC),0))." : ".(round(((array_sum($FH)/array_sum($FC))-round(array_sum($FH)/array_sum($FC),0))*60,0))?></td>
 </tr>
 <tr height=23 style='mso-height-source:userset;height:17.45pt'>
  <td height=23 class=xl611976 style='height:17.45pt'><span
  style='mso-spacerun:yes'>                </span>- Revenue (*)</td>
  <td class=xl621976 x:str><?= (round(array_sum($FHlastyear)/array_sum($FClastyear),0))." : ".(round(((array_sum($FHlastyear)/array_sum($FClastyear))-round(array_sum($FHlastyear)/array_sum($FClastyear),0))*60,0))?></td>
	  <?php
		foreach ($bulan as $key => $value){
  ?>
  <td class=xl631976 style='border-top:none' x:str><?= (round($FH[$value]/$FC[$value],0))." : ".abs(round((($FH[$value]/$FC[$value])-round($FH[$value]/$FC[$value],0))*60,0))?></td>
<?php
 ...
 <tr height=23 style='mso-height-source:userset;height:17.45pt'>
  ...
  <td class=xl621976 x:str><?= round(array_sum($FHlastyear)/array_sum($availablelastyear),0)." : ". round(abs(round(array_sum($FHlastyear)/array_sum($availablelastyear),2) - round(array_sum($FHlastyear)/array_sum($availablelastyear),0))*60,0)?></td>
	  <?php
		foreach ($bulan as $key => $value){
  ?>
  <td class=xl631976 style='border-top:none' x:str><?= round($FH[$value]/$available[$value],0)." : ". round(abs(round($FH[$value]/$available[$value],2) - round($FH[$value]/$available[$value],0))*60,0)?</td>
<?php
		}
   ?>   
  <td class=xl521976><?= round(array_sum($FH)/array_sum($available),0)." : ". round(abs(round(array_sum($FH)/array_sum($available),2) - round(array_sum($FH)/array_sum($available),0))*60,0)?></td>
 </tr>
 <tr height=23 style='mso-height-source:userset;height:17.45pt'>
  ...
  <td class=xl621976 x:str="'7 : 48"><?= (round(array_sum($FHlastyear)/array_sum($availablelastyear),0))." : ".abs(round(((array_sum($FHlastyear)/array_sum($availablelastyear))-round(array_sum($FHlastyear)/array_sum($availablelastyear),0))*60,0))?></td>
	  <?php
		foreach ($bulan as $key => $value){
  ?>
  <td class=xl631976 style='border-top:none' x:str><?= (round($FH[$value]/$available[$value],0))." : ".abs(round((($FH[$value]/$available[$value])-round($FH[$value]/$available[$value],0))*60,0))?></td>
 <?php
		}
   ?> 
  <td class=xl521976><?= (round(array_sum($FH)/array_sum($available),0))." : ".abs(round(((array_sum($FH)/array_sum($available))-round(array_sum($FH)/array_sum($available),0))*60,0))?></td>
 </tr>
 <tr height=23 style='mso-height-source:userset;height:17.45pt'>
  <td height=23 class=xl611976 style='height:17.45pt'><span
  ...
  <td class=xl511976 x:num><?= round(array_sum($FClastyear)/array_sum($availablelastyear),2)?></td>
	  <?php
		foreach ($bulan as $key => $value){
  ?>
  <td class=xl511976 x:num><?= round($FC[$value]/$available[$value],2)?></td>
  <?php
		}
   ?> 
 ...
 <tr height=23 style='mso-height-source:userset;height:17.45pt'>
  ...
  <td class=xl631976 style='border-top:none' x:num><?= round(array_sum($FClastyear)/array_sum($availablelastyear),2)?></td>
	  <?php
		foreach ($bulan as $key => $value){
  ?>
  <td class=xl631976 style='border-top:none;border-left:none' x:num><?= round($FC[$value]/$available[$value],2)?></td>
  <?php
		}
   ?>   
  <td class=xl641976 style='border-top:none;border-left:none'><?= round(array_sum($FC)/array_sum($available),2)?></td>
 </tr>
 <tr height=23 style='mso-height-source:userset;height:17.45pt'>
 ...
 <tr height=23 style='mso-height-source:userset;height:17.45pt'>
  ...
  <td class=xl511976 x:num><?= round(array_sum($delayratelastyear),3)?></td>
	  <?php
		foreach ($bulan as $key => $value){
  ?>
  <td class=xl511976 x:num><?= round($delayrate[$value],3)?></td>
  <?php
		}
   ?>   
 ...
 <tr height=23 style='mso-height-source:userset;height:17.45pt'>
  ...
  <td class=xl491976 x:num>3</td>
  <td class=xl491976 x:num>1</td>
  <td class=xl491976 x:num>0</td>
  <td class=xl491976 x:num>0</td>
  <td class=xl491976 x:num>0</td>
  <td class=xl491976 x:num>0</td>
  <td class=xl491976 x:num>0</td>
  ...
  <td class=xl491976 x:num>0</td>
  <td class=xl491976 x:num>0</td>
  <td class=xl501976 x:num x:fmla="=SUM(C22:N22)">2</td>
 </tr>
 <tr height=23 style='mso-height-source:userset;height:17.45pt'>
  <td height=23 class=xl611976 style='height:17.45pt'><span
  style='mso-spacerun:yes'>   </span>- Rate/1000 Tot.Fly Hours</td>
  <td class=xl511976 x:num="0.23479690068091102">0.23</td>
  <td class=xl511976 x:num="0.78369905956112851">0.78</td>
  <td class=xl511976 x:num>0.00</td>
  <td class=xl511976 x:num>0.00</td>
  <td class=xl511976 x:num>0.00</td>
  <td class=xl511976 x:num>0.00</td>
  <td class=xl511976 x:num>0.00</td>
  <td class=xl511976 x:num>0.00</td>
  <td class=xl511976 x:num="0.94250706880301605">0.94</td>
  <td class=xl511976 x:num>0.00</td>
  <td class=xl511976 x:num>0.00</td>
  <td class=xl511976 x:num>0.00</td>
  <td class=xl511976 x:num x:fmla="=N22/N8*1000">0.00</td>
  <td class=xl521976 x:num="0.16223231667748214" x:fmla="=O22/O8*1000">0.16</td>
 </tr>
 <tr height=23 style='mso-height-source:userset;height:17.45pt'>
  <td height=23 class=xl611976 style='height:17.45pt'>Technical Cancellations</td>
  <td class=xl491976 x:num><?= array_sum($cancellastyear)?></td>
	  <?php
		foreach ($bulan as $key => $value){
  ?>
 ...
 <tr height=23 style='mso-height-source:userset;height:17.45pt'>
  ...
  <td class=xl511976 x:num><?= round((array_sum($FClastyear) - array_sum($techdelaylastyear) - array_sum($cancellastyear))/array_sum($FC) * 100,2) ?></td>
	  <?php
		foreach ($bulan as $key => $value){
  ?>
  <td class=xl511976 x:num><?= round(($FC[$value] - $techdelay[$value] - $cancel[$value])/$FC[$value] * 100,2) ?></td>
    <?php
		}
   ?>  
  <td class=xl521976 x:num><?= round((array_sum($FC) - array_sum($techdelay) - array_sum($cancel))/array_sum($FC) * 100,2) ?></td>
 </tr>
 <tr height=23 style='mso-height-source:userset;height:17.45pt'>
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl351976></td>
  <td class=xl351976></td>
  <td class=xl701976 x:str="'Page : D2">Page : D2</td>
 </tr>
