...
function export_excel()
  {
        if (document.frm1.periode.value == 0) {
        	   ...
        	   //var str = "excel.php?actype=" + escape(document.frm1.actype.value) + "&weeknum=" + escape(document.frm1.weeknum.value)+ "&year=" + escape(document.frm1.year.value);
                window.open("EOS_excel.php?actype=" + escape(document.frm1.actype.value) + "&periode=" + escape(document.frm1.periode.value));
        }
  }
</script>
...
<table width="100%"  border="1" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <th width="20" scope="col"><div align="center"><span class="style2"></span></div></th>
  ...
  <tr>
    ...
    <th width="20"><div align="center"><span class="style2">2007</span></div></th>
<?php
...
?>
  ...
  <tr>
    ...
    <td width="20"><div align="center"><span class="style2">
      <?= round(array_sum($fleetlastyear)/12*$numberofengine,0)?>
    </span></div></td>
<?php
	foreach ($bulan as $key => $value){
?>
...
?>
  ...
  <tr>
    ...
    <td width="20"><div align="center"><span class="style2"></span></div></td>
...
?>
  ...
  <tr>
    ...
    <td width="20"><div align="center"><span class="style2">
      <?= (array_sum($FHlastyear) * $numberofengine)?>
    </span></div></td>
<?php
	foreach ($bulan as $key => $value){
?>
...
?>
  ...
  <tr>
    ...
    <td width="20"><div align="center"><span class="style2">
      <?= (array_sum($FClastyear) * $numberofengine)?>
    </span></div></td>
<?php
	foreach ($bulan as $key => $value){
?>
...
?>
  ...
  <tr>
    ...
    <td width="20"><div align="center"><span class="style2">
      <?= round(($ifsdlastyear/(array_sum($FHlastyear)*$numberofengine)*1000),3)?>
    </span></div></td>
<?php
	foreach ($bulan as $key => $value){
?>
    <td><div align="center"><span class="style2"><?= round(($ifsd[$value]/($FH[$value]*$numberofengine)*1000),3)?></span></div></td>
<?php
	}
?>
  </tr>
...
<?php
	foreach ($bulan as $key => $value){
?>
    <td><div align="center"><span class="style2"><?= round((($ifsd[$bulan12[$key+10]] + $ifsd[$bulan12[$key+11]] + $ifsd[$bulan12[$key+12]])/($FH24[$bulan12[$key+10]] + $FH24[$bulan12[$key+11]] + $FH24[$bulan12[$key+12]]) * 1000),3)?></span></div></td>
<?php
	}
?>
  </tr>
...
?>
  ...
  <tr>
    ...
    <th scope="row"><div align="left" class="style2">- RATE </div></th>
    <td width="20"><div align="center"><span class="style2">
      <?= round(($rtolastyeardata/(array_sum($FHlastyear)*$numberofengine)*1000),3)?>
    </span></div></td>
<?php
	foreach ($bulan as $key => $value){
?>
    <td><div align="center"><span class="style2"><?= round(($rtodat[$value]/($FH[$value]*$numberofengine)*1000),3)?></span></div></td>
<?php
	}
?>
  </tr>
...
<?php
	foreach ($bulan as $key => $value){
?>
    <td><div align="center"><span class="style2"><?= round((($rtodat[$bulan12[$key+10]] + $rtodat[$bulan12[$key+11]] + $rtodat[$bulan12[$key+12]])/($FH24[$bulan12[$key+10]] + $FH24[$bulan12[$key+11]] + $FH24[$bulan12[$key+12]]) * 1000),3)?></span></div></td>
<?php
	}
?>
  </tr>
  ...
  <tr>
    ...
    <td width="20"><div align="center"><span class="style2">
      <?= $engineremovallastyear["Convenience"]?>
    </span></div></td>
<?php
	foreach ($bulan as $key => $value){
?>
...
?>
  ...
  <tr>
    ...
    <td width="20"><div align="center"><span class="style2">
      <?= $engineremovallastyear["Campaign"]?>
    </span></div></td>
<?php
	foreach ($bulan as $key => $value){
?>
...
?>
  ...
  <tr>
    ...
    <td width="20"><div align="center"><span class="style2">
      <?= $engineremovallastyear["Predefined Basic Planned"]?>
    </span></div></td>
<?php
	foreach ($bulan as $key => $value){
?>
...
?>
  ...
  <tr>
    ...
    <td width="20"><div align="center"><span class="style2">
      <?= $engineremovallastyear["Predefined Basic UnPlanned"]?>
    </span></div></td>
<?php
	foreach ($bulan as $key => $value){
?>
...
?>
  ...
  <tr>
    ...
    <td width="20"><div align="center"><span class="style2">
      <?= $engineremovallastyear["Predefined NonBasic Planned"]?>
    </span></div></td>
<?php
	foreach ($bulan as $key => $value){
?>
...
?>
  ...
  <tr>
    <th><div align="left" class="style2">&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;; - UNPLANNED </div></th>
    <td width="20"><div align="center"><span class="style2">
      <?= $engineremovallastyear["Predefined NonBasic UnPlanned"]?>
    </span></div></td>
<?php
	foreach ($bulan as $key => $value){
?>
...
?>  </tr>
  ...
  <tr>
    <th><div align="left" class="style2">* BASIC - PLANNED </div></th>
    <td width="20"><div align="center"><span class="style2">
      <?= $engineremovallastyear["Premature Basic Planned"]?>
    </span></div></td>
<?php
	foreach ($bulan as $key => $value){
?>
...
?>
  ...
  <tr>
    <th><div align="left" class="style2">&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;; - UNPLANNED </div></th>
    <td width="20"><div align="center"><span class="style2">
      <?= $engineremovallastyear["Premature Basic UnPlanned"]?>
    </span></div></td>
<?php
	foreach ($bulan as $key => $value){
?>
...
?>  </tr>
  <tr>
    <th><div align="left" class="style2">* NON BASIC - PLANNED </div></th>
    <td width="20"><div align="center"><span class="style2">
      <?= $engineremovallastyear["Premature NonBasic Planned"]?>
    </span></div></td>
<?php
	foreach ($bulan as $key => $value){
?>
...
?>  </tr>
  <tr>
    <th><div align="left" class="style2">&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;;&nbsp;; - UNPLANNED </div></th>
    <td width="20"><div align="center"><span class="style2">
      <?= $engineremovallastyear["Premature NonBasic UnPlanned"]?>
    </span></div></td>
<?php
	foreach ($bulan as $key => $value){
?>
...
?>  </tr>
  ...
  <tr>
    ...
    <td width="20"><div align="center"><span class="style2">
      <?= ($engineremovallastyear["Premature NonBasic UnPlanned"] + $engineremovallastyear["Premature Basic UnPlanned"] + $engineremovallastyear["Predefined Basic UnPlanned"] + $engineremovallastyear["Predefined NonBasic UnPlanned"])?>
    </span></div></td>
<?php
	foreach ($bulan as $key => $value){
?>
...
?> 
  ...
  <tr>
    ...
    <td width="20"><div align="center"><span class="style2">
      <?= round(($engineremovallastyear["Premature NonBasic UnPlanned"] + $engineremovallastyear["Premature Basic UnPlanned"] + $engineremovallastyear["Predefined Basic UnPlanned"] + $engineremovallastyear["Predefined NonBasic UnPlanned"])/(array_sum($FHlastyear) * $numberofengine)*1000,3)?>
    </span></div></td>
<?php
	foreach ($bulan as $key => $value){
?>
    <td><div align="center"><span class="style2">
        <?= round((($engineremoval["Predefined Basic UnPlanned"][$value] + $engineremoval["Predefined NonBasic UnPlanned"][$value] + $engineremoval["Premature Basic UnPlanned"][$value] + $engineremoval["Premature NonBasic UnPlanned"][$value])/($FH[$value] * $numberofengine)*1000),3)?>
    </span></div></td>
<?php
	}
?> 
...
?>
  ...
  <tr>
    ...
    <td width="20"><div align="center"><span class="style2">
      <?= $engineremovallastyear["Premature Basic Planned"] + $engineremovallastyear["Premature Basic UnPlanned"] + $engineremovallastyear["Premature NonBasic Planned"] + $engineremovallastyear["Premature NonBasic UnPlanned"]?>
    </span></div></td>
<?php
	foreach ($bulan as $key => $value){
?>
...
?>   </tr>
  <tr>
    ...
    <td width="20"><div align="center"><span class="style2">
      <?= round((($engineremovallastyear["Premature Basic Planned"] + $engineremovallastyear["Premature Basic UnPlanned"] + $engineremovallastyear["Premature NonBasic Planned"] + $engineremovallastyear["Premature NonBasic UnPlanned"])/(array_sum($FHlastyear)*$numberofengine)*1000),3)?>
    </span></div></td>
<?php
	foreach ($bulan as $key => $value){
?>
    <td><div align="center"><span class="style2">
        <?= round((($engineremoval["Premature Basic Planned"][$value] + $engineremoval["Premature Basic UnPlanned"][$value] + $engineremoval["Premature NonBasic Planned"][$value] + $engineremoval["Premature NonBasic UnPlanned"][$value])/($FH[$value] * $numberofengine)*1000),3)?>
    </span></div></td>
<?php
	}
?>  </tr>
...
<?php
	foreach ($bulan as $key => $value){
?>
    <td><div align="center"><span class="style2"><?= round((($engineremoval["Premature Basic Planned"][$bulan12[$key+10]] + $engineremoval["Premature Basic UnPlanned"][$bulan12[$key+10]] + $engineremoval["Premature NonBasic Planned"][$bulan12[$key+10]] + $engineremoval["Premature NonBasic UnPlanned"][$bulan12[$key+10]] + $engineremoval["Premature Basic Planned"][$bulan12[$key+11]] + $engineremoval["Premature Basic UnPlanned"][$bulan12[$key+11]] + $engineremoval["Premature NonBasic Planned"][$bulan12[$key+11]] + $engineremoval["Premature NonBasic UnPlanned"][$bulan12[$key+11]] + $engineremoval["Premature Basic Planned"][$value] + $engineremoval["Premature Basic UnPlanned"][$value] + $engineremoval["Premature NonBasic Planned"][$value] + $engineremoval["Premature NonBasic UnPlanned"][$value])/(($FH24[$bulan12[$key+10]] + $FH24[$bulan12[$key+11]] + $FH24[$bulan12[$key+12]]) * $numberofengine)*1000),3)?></span></div></td>
<?php
	}
?>  
  </tr>
...
?> 
  ...
  <tr>
    ...
    <th><div align="left" class="style2">- RATE </div></th>
    <td width="20"><div align="center"><span class="style2">
      <?= round((($engineremovallastyear["Premature Basic Planned"] + $engineremovallastyear["Premature Basic UnPlanned"] + $engineremovallastyear["Premature NonBasic Planned"] + $engineremovallastyear["Premature NonBasic UnPlanned"] + $engineremovallastyear["Predefined Basic Planned"] + $engineremovallastyear["Predefined Basic UnPlanned"] + $engineremovallastyear["Predefined NonBasic Planned"] + $engineremovallastyear["Predefined NonBasic UnPlanned"])/(array_sum($FHlastyear)*$numberofengine)*1000),3)?>
    </span></div></td>
<?php
	foreach ($bulan as $key => $value){
?>
    <td><div align="center"><span class="style2">
        <?= round((($engineremoval["Premature Basic Planned"][$value] + $engineremoval["Premature Basic UnPlanned"][$value] + $engineremoval["Premature NonBasic Planned"][$value] + $engineremoval["Premature NonBasic UnPlanned"][$value] + $engineremoval["Predefined Basic Planned"][$value] + $engineremoval["Predefined Basic UnPlanned"][$value] + $engineremoval["Predefined NonBasic Planned"][$value] + $engineremoval["Predefined NonBasic UnPlanned"][$value] + $engineremoval["Campaign"][$value])/($FH[$value] * $numberofengine)*1000),3)?>
    </span></div></td>
<?php
	}
?> 
...
?> 
  ...
  <tr>
    ...
    <td width="20"><div align="center"><span class="style2">
      <?= round((($engineremovallastyear["Premature Basic Planned"] + $engineremovallastyear["Premature Basic UnPlanned"] + $engineremovallastyear["Premature NonBasic Planned"] + $engineremovallastyear["Premature NonBasic UnPlanned"] + $engineremovallastyear["Predefined Basic Planned"] + $engineremovallastyear["Predefined Basic UnPlanned"] + $engineremovallastyear["Predefined NonBasic Planned"] + $engineremovallastyear["Predefined NonBasic UnPlanned"] + $engineremovallastyear["Convenience"] + $engineremovallastyear["Campaign"])/(array_sum($FHlastyear)*$numberofengine)*1000),3)?>
    </span></div></td>
<?php
	foreach ($bulan as $key => $value){
?>
    <td><div align="center"><span class="style2">
        <?= round((($engineremoval["Premature Basic Planned"][$value] + $engineremoval["Premature Basic UnPlanned"][$value] + $engineremoval["Premature NonBasic Planned"][$value] + $engineremoval["Premature NonBasic UnPlanned"][$value] + $engineremoval["Predefined Basic Planned"][$value] + $engineremoval["Predefined Basic UnPlanned"][$value] + $engineremoval["Predefined NonBasic Planned"][$value] + $engineremoval["Predefined NonBasic UnPlanned"][$value] + $engineremoval["Campaign"][$value] + $engineremoval["Convenience"][$value])/($FH[$value] * $numberofengine)*1000),3)?>
    </span></div></td>
<?php
	}
?>
