...
function weeks_in_year($year) {
  $weekno = date("W",mktime(23,00,00,12,31,$year));
  $i = 1;
  while ($weekno == 01){
	$weekno = date("W",mktime(23,00,00,12,31-$i,$year));
	$i++;
  }
  return $weekno;
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=896 style='border-collapse:
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  <?php
	...
	$avail = queryavail($weeknih,$actype);
 ...
 <tr height=21 style='height:15.75pt'>
  <td height=21 class=xl222569 style='height:15.75pt'>AC In Service</td>
	  ...
	  for($i=0;$i<11;$i++)
		{
			...
			echo "<td class=xl242569 x:num>".$availdat[$i]."</td>";
		}
	  ?>
	  <td class=xl262569 x:num><?= round(($availdat[10] + $availdat[9] + $availdat[8] + $availdat[7])/4,0)?></td>
 </tr>
  </tr>
 <tr height=21 style='height:15.75pt'>
 ...
 <tr height=22 style='height:16.5pt'>
  ...
  <td class=xl302569 x:num="96.566523605150209" x:fmla="=C9">96.57</td>
  <td class=xl302569 x:num x:fmla="=D9">100.00</td>
  <td class=xl302569 x:num x:fmla="=E9">100.00</td>
  <td class=xl302569 x:num x:fmla="=F9">100.00</td>
  <td class=xl302569 x:num x:fmla="=G9">100.00</td>
  <td class=xl302569 x:num x:fmla="=H9">100.00</td>
  <td class=xl302569 x:num x:fmla="=I9">100.00</td>
  <td class=xl302569 x:num x:fmla="=J9">100.00</td>
  <td class=xl302569 x:num="98.275126144363043" x:fmla="=K9">98.28</td>
  <td class=xl302569 x:num x:fmla="=L9">100.00</td>
  <td class=xl302569 x:num="98.276465140584293" x:fmla="=M9">98.28</td>
  <td class=xl302569 x:num="98.275795624235698" x:fmla="=N9">98.28</td>
 </tr>
 <tr height=21 style='height:15.75pt'>
  <td height=21 class=xl322569 style='height:15.75pt'></td>
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  x:fmla="=(C5/C7)*100">3.43</td>
  <td class=xl342569 align=right x:num x:fmla="=(D5/D7)*100">0.00</td>
  <td class=xl342569 align=right x:num x:fmla="=(E5/E7)*100">0.00</td>
  <td class=xl342569 align=right x:num x:fmla="=(F5/F7)*100">0.00</td>
  <td class=xl342569 align=right x:num x:fmla="=(G5/G7)*100">0.00</td>
  <td class=xl342569 align=right x:num x:fmla="=(H5/H7)*100">0.00</td>
  <td class=xl342569 align=right x:num x:fmla="=(I5/I7)*100">0.00</td>
  <td class=xl342569 align=right x:num x:fmla="=(J5/J7)*100">0.00</td>
  <td class=xl342569 align=right x:num="1.7248738556369596"
  x:fmla="=(K5/K7)*100">1.72</td>
  <td class=xl342569 align=right x:num x:fmla="=(L5/L7)*100">0.00</td>
  <td class=xl342569 align=right x:num="1.7235348594157107"
  x:fmla="=(M5/M7)*100">1.72</td>
  <td class=xl342569 align=right x:num="1.7242043757643031"
  x:fmla="=(N5/N7)*100">1.72</td>
 </tr>
