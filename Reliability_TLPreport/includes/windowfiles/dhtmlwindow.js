...
var dhtmlwindow={
imagefiles:['includes/dhtmlmodal/windowfiles/min.gif', 'includes/dhtmlmodal/windowfiles/close.gif', 'includes/dhtmlmodal/windowfiles/restore.gif', 'includes/dhtmlmodal/windowfiles/resize.gif'], //Path to 4 images used by script, in that order
...
setupdrag:function(e){
	...
	if (t.contentarea.datatype=="iframe"){ //if content of this window div is "iframe"
		t.style.backgroundColor="#dcf1f2" //colorize and hide content div (while window is being dragged)
