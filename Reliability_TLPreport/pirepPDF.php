...
function data($bulan,$ATApirep,$ATA12bulan,$alertlevel,$ATA,$ATAdesc,$FH,$FH12,$pembagi,$actype,$preselectpirep){
	...
	$this->Cell(11,4.5,(($actype != "B737-300") && ($actype != "A330-200")) ? round($alertlevel[$ATA[$i]],2) : "",'TBLR',0,'C',(($actype != "B737-300") && ($actype != "A330-200")) ? 0 : 1);
	$this->Cell(12,4.5,(($actype != "B737-300") && ($FH[$bulan[0]] <> 0) && ($FH[$bulan[1]] <> 0) && ($FH[$bulan[2]] <> 0)) ? alertstatus(round($ATApirep[$bulan[2]][$ATA[$i]]/$FH[$bulan[2]]*$pembagi,2),round($ATApirep[$bulan[1]][$ATA[$i]]/$FH[$bulan[1]]*$pembagi,2),round($ATApirep[$bulan[0]][$ATA[$i]]/$FH[$bulan[0]]*$pembagi,2),$alertlevel[$ATA[$i]]) : "",'TBLR',0,'C',($actype != "B737-300") ? 0 : 1);
...
function OT($bulan,$ATApirep,$ATA12bulan,$alertlevel,$ATA,$ATAdesc,$FH,$FH12,$pembagi,$actype){
	...
	$this->Cell(11,4.5,(($actype != "B737-300") && ($actype != "A330-200")) ? round($alertlevel['OT'],2) : "",'TBLR',0,'C',(($actype != "B737-300") && ($actype != "A330-200")) ? 0 : 1);
	$this->Cell(12,4.5,(($actype != "B737-300") && ($FH[$bulan[2]] != 0) && ($FH[$bulan[1]] != 0) && ($FH[$bulan[0]])) ? alertstatus(round($ATApirep[$bulan[2]]['OT']/$FH[$bulan[2]]*$pembagi,2),round($ATApirep[$bulan[1]]['OT']/$FH[$bulan[1]]*$pembagi,2),round($ATApirep[$bulan[0]]['OT']/$FH[$bulan[0]]*$pembagi,2),$alertlevel['OT']) : "",'TBLR',0,'C',($actype != "B737-300") ? 0 : 1);
...
$pdf->Line(17,225,199,225);

$pdf->Line(17,30,17,225);
$pdf->Line(57,42,57,225);
$pdf->Line(109,42,109,225);
$pdf->Line(164,46,164,225);
$pdf->Line(199,30,199,225);
...
$pdf->SetFillColor(200);
$pdf->data($bulan,$ATAmarep,$ATAmarep12bulan,$alertlevelmarep,$ATA,$ATAdesc,$FH,$FH12,1000,$actype,$preselectpirep);
$pdf->bln();
if ($actype == "A320-200") {
	$pdf->Cell(170,10,'issued by Citilink Engineering & Maintenance and Compiled by GMF Reliability Engineering & Services',0,0,'R');	
}
...
$pdf->Line(17,46,199,46);
$pdf->Line(57,54,199,54);
$pdf->Line(17,229.5,199,229.5);

$pdf->Line(17,30,17,229.5);
$pdf->Line(57,42,57,229.5);
$pdf->Line(109,42,109,229.5);
$pdf->Line(164,46,164,229.5);
$pdf->Line(199,30,199,229.5);
