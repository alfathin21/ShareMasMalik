...
function BasicTable($header,$actype,$periode)
{
    ...
    //    $this->Cell(40,17,$col,10);
		...
		$this->Ln();
		$this->Cell(275,7,(($actype == "ATR72-600") ? "" :(($actype == "A330-300") || ($actype == "A330-200") || ($actype == "A320-200") ? "AIRBUS" : (($actype == "CRJ-1000") ? "BOMBARDIER" :  "BOEING")))." ".$actype,'LRB',0,'C');
		$this->Ln();
...
function JudulCumulative($header,$actype,$periode,$tinggi,$reghal)
{
    ...
    //    $this->Cell(40,17,$col,10);
		...
		$this->Ln();
		$this->Cell(272,7,(($actype == "A330-300") || ($actype == "A330-200") || ($actype == "A320-200") ? "AIRBUS" : (($actype == "CRJ-1000") ? "BOMBARDIER" : (($actype == "ATR72-600") ? "" : "BOEING")))." ".$actype,'LRB',0,'C');
		$this->Ln();
...
$L = 14;
	...
	$this->Cell(60,4,(($actype == "A330-300") || ($actype == "A330-200") || ($actype == "A320-200") ? "AIRBUS" : (($actype == "CRJ-1000") ? "BOMBARDIER" : (($actype == "ATR72-600") ? "" : "BOEING"))).' '.$actype,1,0,'C');
	$this->Cell($L,4,'',1,0,'C');
