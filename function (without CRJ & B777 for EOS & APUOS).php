...
function fleet($time,$actype)
{
	...
	if ($actype == "B737-Classic") {
		...
		$qryline = "`tbl_monthlyfhfc`.`Actype` IN ('A330-200','A330-300')";
	} else if ($actype == "ATR72-600-GA") {
		$qryline = "(`tbl_monthlyfhfc`.`Reg` Like 'PK-GA%')";
	} else if ($actype == "ATR72-600-QG") {
		$qryline = "(`tbl_monthlyfhfc`.`Reg` Like 'PK-GJ%')";			
	} else if ($actype == "B737-800-E") {
		$qryline = "`tbl_monthlyfhfc`.`Reg` Like 'PK-GE%'";
	} else if ($actype == "B737-800") {
		$qryline = "(`tbl_monthlyfhfc`.`Reg` Like 'PK-GM%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GF%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GN%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GE%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GD%')";		
	} else if ($actype == "B737-800-M") {
		$qryline = "(`tbl_monthlyfhfc`.`Reg` Like 'PK-GM%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GF%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GN%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GD%')";
	...
	$qryFH = "SELECT DISTINCT Count(`tbl_monthlyfhfc`.`IDReg`) AS `jumlah`, DATE_FORMAT(tbl_monthlyfhfc.MonthEval,'%Y-%m') AS `periode`, `tbl_monthlyfhfc`.`Actype` AS `ACType` FROM `tbl_monthlyfhfc` WHERE ".$qryline." AND (`tbl_monthlyfhfc`.`Remark` <> 'out' OR `tbl_monthlyfhfc`.`Remark` is NULL) AND DATE_FORMAT(`tbl_monthlyfhfc`.`MonthEval`,'%Y-%m') <= '".$time."' GROUP BY DATE_FORMAT(tbl_monthlyfhfc.MonthEval,'%Y-%m') ORDER BY  DATE_FORMAT(tbl_monthlyfhfc.MonthEval,'%Y-%m') DESC LIMIT 12";
...
function queryFH($time,$actype)
{
	...
	if ($actype == "B737-Classic") {
		...
		$qryline = "(`tbl_monthlyfhfc`.`Reg` Like 'PK-GM%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GF%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GN%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GE%')";		
	} else if ($actype == "B737-800-M") {
		$qryline = "(`tbl_monthlyfhfc`.`Reg` Like 'PK-GM%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GF%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GN%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GD%')";	
	} else if ($actype == "CFM56-5") {
		$qryline = "(`tbl_monthlyfhfc`.`Reg` IN (SELECT ACReg FROM tbl_masterac WHERE EngineType = 'CFM56-5B4/3'))";
...
function queryFC12($time,$actype,$limit)
{
	...
	if ($actype == "B737-Classic") {
		...
		$qryline = "(`tbl_monthlyfhfc`.`Reg` Like 'PK-GM%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GF%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GN%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GD%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GE%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GD%')";		
	} else if ($actype == "B737-800-M") {
		$qryline = "(`tbl_monthlyfhfc`.`Reg` Like 'PK-GM%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GF%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GN%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GD%')";
	} else if ($actype == "CFM56-5") {
		$qryline = "(`tbl_monthlyfhfc`.`Reg` IN (SELECT ACReg FROM tbl_masterac WHERE EngineType = 'CFM56-5B4/3'))";
...
function queryFHapu12($time,$actype,$limit)
{
	global $connectAMS;
	if ($actype == "B737-Classic") {
		$qryline = "`tbl_monthlyapu_util`.`Actype` IN ('B737-300','B737-400','B737-500','B737-CL')";
	} else if ($actype == "B737-Classic GA") {
		$qryline = "`tbl_monthlyapu_util`.`Actype` IN ('B737-300','B737-400','B737-500')";
	} else if ($actype == "A330") {
		$qryline = "`tbl_monthlyapu_util`.`Actype` IN ('A330-200','A330-300')";		
	} else if ($actype == "B737-800-E") {
		$qryline = "`tbl_monthlyapu_util`.`Reg` Like 'PK-GE%'";
	} else if ($actype == "B737-800") {
		$qryline = "(`tbl_monthlyapu_util`.`Reg` Like 'PK-GM%' or `tbl_monthlyapu_util`.`Reg` Like 'PK-GF%' or `tbl_monthlyapu_util`.`Reg` Like 'PK-GN%' or `tbl_monthlyapu_util`.`Reg` Like 'PK-GE%' or `tbl_monthlyapu_util`.`Reg` Like 'PK-GD%')";
	} else if ($actype == "B737-800-M") {
		$qryline = "(`tbl_monthlyapu_util`.`Reg` Like 'PK-GM%' or `tbl_monthlyapu_util`.`Reg` Like 'PK-GF%' or `tbl_monthlyapu_util`.`Reg` Like 'PK-GN%' or `tbl_monthlyapu_util`.`Reg` Like 'PK-GE%' or `tbl_monthlyapu_util`.`Reg` Like 'PK-GD%')";		
	} else {
		$qryline = "`tbl_monthlyapu_util`.`Actype` IN ('$actype')";
	}

	$qryFH = "SELECT Sum(`tbl_monthlyapu_util`.`HoursUtil`) AS `HoursUtil`, Sum(`tbl_monthlyapu_util`.`CycleUtil`) AS `CycleUtil`, DATE_FORMAT(tbl_monthlyapu_util.MonthEval,'%Y-%m') AS `periode` FROM `tbl_monthlyapu_util` WHERE ".$qryline." AND DATE_FORMAT(`tbl_monthlyapu_util`.`MonthEval`,'%Y-%m') <= '".$time."' GROUP BY DATE_FORMAT(`tbl_monthlyapu_util`.`MonthEval`,'%Y-%m') ORDER BY DATE_FORMAT(`tbl_monthlyapu_util`.`MonthEval`,'%Y-%m') DESC LIMIT ".$limit;
	
	$resultFH = mysqli_query($connectAMS,$qryFH);
	//die($qryFH);
	while ($hasilFH = mysqli_fetch_array($resultFH))
	{
		$hour[$hasilFH["periode"]] = $hasilFH["HoursUtil"];
	}
	
	return $hour;
}

function queryFCapu12($time,$actype,$limit)
{
	global $connectAMS;
	if ($actype == "B737-Classic") {
		$qryline = "`tbl_monthlyapu_util`.`Actype` IN ('B737-300','B737-400','B737-500','B737-CL')";
		...
		$qryline = "(`tbl_monthlyapu_util`.`Reg` Like 'PK-GM%' or `tbl_monthlyapu_util`.`Reg` Like 'PK-GF%' or `tbl_monthlyapu_util`.`Reg` Like 'PK-GN%' or `tbl_monthlyapu_util`.`Reg` Like 'PK-GD%')";		
	} else {
		$qryline = "`tbl_monthlyapu_util`.`Actype` IN ('$actype')";
	}
	...
	while ($hasilFH = mysqli_fetch_array($resultFH))
	{
		$cycle[$hasilFH["periode"]] = $hasilFH["CycleUtil"];
	}
...
{
	global $connectAMS;
	$qryFH = "SELECT `tbl_master_ata`.`ATA`, `tbl_master_ata`.`ATA_DESC` FROM `tbl_master_ata` WHERE `tbl_master_ata`.`ATA` > '20' AND `tbl_master_ata`.`ATA` <> '58' AND `tbl_master_ata`.`ATA` <> '70' ORDER BY `tbl_master_ata`.`ATA`";
	$resultFH = mysqli_query($connectAMS,$qryFH);
	//die($qryFH);
	while ($hasilFH = mysqli_fetch_array($resultFH))
	{
...
function ATA($timeawal,$timeakhir,$actype)//query untuk  Report
{
	...
	if ($actype == "B737-Classic") {
		...
		$qryline = "(`tblpirep_swift`.`REG` Like 'GA%')";
	} else if ($actype == "ATR72-600-QG") {
		$qryline = "(`tblpirep_swift`.`REG` Like 'GJ%')";			
	} else if ($actype == "B737-800-E") {
		$qryline = "`tblpirep_swift`.`REG` Like 'GE%'";
	} else if ($actype == "B737-800") {
		$qryline = "(`tblpirep_swift`.`REG` Like 'GM%' or `tblpirep_swift`.`REG` Like 'GF%' or `tblpirep_swift`.`REG` Like 'GN%' or `tblpirep_swift`.`REG` Like 'GE%' or `tblpirep_swift`.`REG` Like 'GD%')";		
	} else if ($actype == "B737-800-M") {
		$qryline = "(`tblpirep_swift`.`REG` Like 'GM%' or `tblpirep_swift`.`REG` Like 'GF%' or `tblpirep_swift`.`REG` Like 'GN%' or `tblpirep_swift`.`REG` Like 'GD%')";
	} else {
		$qryline = "`tblpirep_swift`.`ACTYPE` IN ('$actype')";
	}
	
	$qryFH = "SELECT Count(`tblpirep_swift`.`ATA`) AS `Jumlah`, `tblpirep_swift`.`ATA`  AS `subjectATA`, DATE_FORMAT(`tblpirep_swift`.`DATE`,'%Y-%m') AS `bulan` FROM `tblpirep_swift` WHERE ".$qryline." AND (DATE_FORMAT(`tblpirep_swift`.`DATE`,'%Y-%m') BETWEEN '".$timeawal."' AND '".$timeakhir."') AND (`tblpirep_swift`.`PirepMarep` = 'Pirep' OR `tblpirep_swift`.`PirepMarep` IS NULL) GROUP BY `tblpirep_swift`.`ATA`,  DATE_FORMAT(`tblpirep_swift`.`DATE`,'%Y-%m') ORDER BY DATE_FORMAT(`tblpirep_swift`.`DATE`,'%Y-%m') DESC";
	$resultFH = mysqli_query($connectAMS,$qryFH);
	//die($qryFH);
	while ($hasilFH = mysqli_fetch_array($resultFH))
	{
...
function ATA12($timeawal,$timeakhir,$actype)////query untuk ATA 12 Month Pilot Report 
{
	...
	$qryFH = "SELECT Count(`tblpirep_swift`.`ATA`) AS `Jumlah`, `tblpirep_swift`.`ATA` AS `subjectATA` FROM `tblpirep_swift` WHERE ".$qryline." AND DATE_FORMAT(`tblpirep_swift`.`DATE`,'%Y-%m') BETWEEN '".$timeawal."' AND '".$timeakhir."' AND (`tblpirep_swift`.`PirepMarep` = 'Pirep' OR `tblpirep_swift`.`PirepMarep` IS NULL) GROUP BY `tblpirep_swift`.`ATA`";
	$resultFH = mysqli_query($connectAMS,$qryFH);
	//die($qryFH);
	while ($hasilFH = mysqli_fetch_array($resultFH))
	{
...
function alert($timeawal,$timeakhir,$actype)//query untuk Alert Level Pilot Report
{
	...
	if ($actype == "B737-Classic") {
		...
		$qryline = "(`tblpirep_swift`.`REG` Like 'GM%' or `tblpirep_swift`.`REG` Like 'GF%' or `tblpirep_swift`.`REG` Like 'GN%' or `tblpirep_swift`.`REG` Like 'GE%')";		
	} else {
		$qryline = "`tblpirep_swift`.`ACTYPE` IN ('$actype')";
	}
	...
	if ($actype == "B737-Classic") {
		...
		$qryline1 = "`tbl_monthlyfhfc`.`Actype` IN ('A330-200','A330-300')";
	} else if ($actype == "ATR72-600-GA") {
		$qryline1 = "`tbl_monthlyfhfc`.`Reg` Like 'PK-GA%'";
	} else if ($actype == "ATR72-600-QG") {
		$qryline1 = "`tbl_monthlyfhfc`.`Reg` Like 'PK-GJ%'";		
	} else if ($actype == "B737-800-E") {
		$qryline1 = "`tbl_monthlyfhfc`.`Reg` Like 'PK-GE%'";
	} else if ($actype == "B737-800") {
		$qryline1 = "(`tbl_monthlyfhfc`.`Reg` Like 'PK-GM%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GF%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GN%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GE%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GD%')";		
	} else if ($actype == "B737-800-M") {
		$qryline1 = "(`tbl_monthlyfhfc`.`Reg` Like 'PK-GM%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GF%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GN%' or `tbl_monthlyfhfc`.`Reg` Like 'PK-GD%')";
	} else {
...
function ATAdelay($timeawal,$timeakhir,$actype)//query untuk delay 
{
	...
	if ($actype == "B737-Classic") {
		...
		$qryline = "`mcdrnew`.`Reg` Like 'PK-GA%'";
	} else if ($actype == "ATR72-600-QG") {
		$qryline = "`mcdrnew`.`Reg` Like 'PK-GJ%'";			
	} else if ($actype == "B737-800-E") {
		$qryline = "`mcdrnew`.`Reg` Like 'PK-GE%'";
	} else if ($actype == "B737-800") {
		$qryline = "(`mcdrnew`.`Reg` Like 'PK-GM%' or `mcdrnew`.`Reg` Like 'PK-GF%' OR `mcdrnew`.`Reg` Like 'PK-GN%' OR `mcdrnew`.`Reg` Like 'PK-GE%' OR `mcdrnew`.`Reg` Like 'PK-GD%')";
	} else if ($actype == "B737-800-M" ) {
		$qryline = "(`mcdrnew`.`Reg` Like 'PK-GM%' or `mcdrnew`.`Reg` Like 'PK-GF%' OR `mcdrnew`.`Reg` Like 'PK-GN%' OR `mcdrnew`.`Reg` Like 'PK-GD%')";
	} else {
...
//section tambahan buat marep
function ATAmar($timeawal,$timeakhir,$actype)//query untuk  Report
{
	global $connectAMS;
	if ($actype == "B737-Classic") {
		$qryline = "`tblpirep_swift`.`ACTYPE` IN ('B737-300','B737-400','B737-500','B737-CL')";
...
function ATA12mar($timeawal,$timeakhir,$actype)////query untuk ATA 12 Month Pilot Report 
{
	global $connectAMS;
	if ($actype == "B737-Classic") {
		$qryline = "`tblpirep_swift`.`ACTYPE` IN ('B737-300','B737-400','B737-500','B737-CL')";
...
function alertmar($timeawal,$timeakhir,$actype)//query untuk Alert Level Maintenance Report
{
	global $connectAMS;
	if ($actype == "B737-Classic") {
		$qryline = "`tblpirep_swift`.`ACTYPE` IN ('B737-300','B737-400','B737-500','B737-CL')";
...
//end section tambahan buat marep
...
function engineremoval($time,$actype)
{
	...
	if ($actype == "B737-Classic") {
		...
		$qryline = "`tbl_engineremove`.`AircraftReg` Like 'PK-GA%'";
	} else if ($actype == "ATR72-600-QG") {
		$qryline = "`tbl_engineremove`.`AircraftReg` Like 'PK-GJ%'";		
	} else if ($actype == "B737-800-E") {
		$qryline = "`tbl_engineremove`.`AircraftReg` Like 'PK-GE%'";
	} else if ($actype == "B737-800") {
		$qryline = "(`tbl_engineremove`.`AircraftReg` Like 'PK-GM%' or `tbl_engineremove`.`AircraftReg` Like 'PK-GF%' or `tbl_engineremove`.`AircraftReg` Like 'PK-GN%' or `tbl_engineremove`.`AircraftReg` Like 'PK-GE%' or `tbl_engineremove`.`AircraftReg` Like 'PK-GD%')";
	} else if ($actype == "B737-800-M") {
		$qryline = "(`tbl_engineremove`.`AircraftReg` Like 'PK-GM%' or `tbl_engineremove`.`AircraftReg` Like 'PK-GF%' or `tbl_engineremove`.`AircraftReg` Like 'PK-GN%' or `tbl_engineremove`.`AircraftReg` Like 'PK-GD%')";		
	} else if ($actype == "V2500") {
...
function engineremoval12($timeawal,$timeakhir,$actype)
{
	...
	if ($actype == "B737-Classic") {
		...
		$qryline = "(`tbl_engineremove`.`AircraftReg` Like 'PK-GM%' or `tbl_engineremove`.`AircraftReg` Like 'PK-GF%' or `tbl_engineremove`.`AircraftReg` Like 'PK-GE%' or `tbl_engineremove`.`AircraftReg` Like 'PK-GD%')";
	} else if ($actype == "B737-800-M") {
		$qryline = "(`tbl_engineremove`.`AircraftReg` Like 'PK-GM%' or `tbl_engineremove`.`AircraftReg` Like 'PK-GF%' or `tbl_engineremove`.`AircraftReg` Like 'PK-GN%' or `tbl_engineremove`.`AircraftReg` Like 'PK-GD%')";		
	} else if ($actype == "V2500") {
		$qryline = "(`tbl_engineremove`.`AircraftReg` IN (".A320($actype)."))";
...
function A320($actype){
	global $connectAMS;
	if ($actype == "V2500"){
		$qry = mysqli_query($connectAMS,"SELECT ACReg FROM tbl_masterac WHERE EngineType LIKE 'V25%'");
	} else {
		$qry = mysqli_query($connectAMS,"SELECT ACReg FROM tbl_masterac WHERE EngineType LIKE 'CFM56-5%'");
	}
	$t = "";
...
function apuremoval($time,$actype)
{
	...
	if ($actype == "B737-Classic") {
		...
		$qryline = "`tbl_apuremove`.`AircraftType` IN ('A330-200','A330-300')";		
	} else if ($actype == "B737-800-E") {
		$qryline = "`tbl_apuremove`.`AircraftReg` Like 'PK-GE%'";
	} else if ($actype == "B737-800") {
		$qryline = "(`tbl_apuremove`.`AircraftReg` Like 'PK-GM%' or `tbl_apuremove`.`AircraftReg` Like 'PK-GF%' or `tbl_apuremove`.`AircraftReg` Like 'PK-GN%' or `tbl_apuremove`.`AircraftReg` Like 'PK-GE%' or `tbl_apuremove`.`AircraftReg` Like 'PK-GD%')";
	} else if ($actype == "B737-800-M") {
		$qryline = "(`tbl_apuremove`.`AircraftReg` Like 'PK-GM%' or `tbl_apuremove`.`AircraftReg` Like 'PK-GF%' or `tbl_apuremove`.`AircraftReg` Like 'PK-GN%' or `tbl_apuremove`.`AircraftReg` Like 'PK-GD%')";		
	} else {
...
function ifsd($time,$actype)
{
	...
	if ($actype == "B737-Classic") {
		...
		$qryline = "`tbl_ifsd`.`ACType` IN ('A330-200','A330-300')";
	} else if ($actype == "ATR72-600-GA") {
		$qryline = "`tbl_ifsd`.`ACReg` Like 'PK-GA%'";
	} else if ($actype == "ATR72-600-QG") {
		$qryline = "`tbl_ifsd`.`ACReg` Like 'PK-GJ%'";		
	} else if ($actype == "B737-800-E") {
		$qryline = "`tbl_ifsd`.`ACReg` Like 'PK-GE%'";
	} else if ($actype == "B737-800") {
		$qryline = "(`tbl_ifsd`.`ACReg` Like 'PK-GM%' or `tbl_ifsd`.`ACReg` Like 'PK-GF%' or `tbl_ifsd`.`ACReg` Like 'PK-GN%' or `tbl_ifsd`.`ACReg` Like 'PK-GE%' or `tbl_ifsd`.`ACReg` Like 'PK-GD%')";
	} else if ($actype == "B737-800-M") {
		$qryline = "(`tbl_ifsd`.`ACReg` Like 'PK-GM%' or `tbl_ifsd`.`ACReg` Like 'PK-GF%' or `tbl_ifsd`.`ACReg` Like 'PK-GN%' or `tbl_ifsd`.`ACReg` Like 'PK-GD%')";		
	} else {
		$qryline = "`tbl_ifsd`.`ACType` IN ('$actype')";
	}

	$qryFH = "SELECT `tbl_ifsd`.`ACType`, DATE_FORMAT(`tbl_ifsd`.`DateOccur`,'%Y-%m') AS `periode`, COUNT(`tbl_ifsd`.`ID`) AS `jumlah` FROM `tbl_ifsd` WHERE  ".$qryline." AND DATE_FORMAT(`tbl_ifsd`.`DateOccur`,'%Y-%m') <= '".$time."' AND `tbl_ifsd`.`ifsd` = 'IFSD' GROUP BY DATE_FORMAT(`tbl_ifsd`.`DateOccur`,'%Y-%m')";
	$resultFH = mysqli_query($connectAMS,$qryFH);
	//die($qryFH);
	while ($hasilFH = mysqli_fetch_array($resultFH))
	{
...
function oilcons($timeawal,$timeakhir,$acreg)//query untuk component removal
{
	...
	$resultoil = mysqli_query($connectAMS,$qryoil);
	//die($qryFH);
	while ($hasiloil = mysqli_fetch_array($resultoil))
	{
...
function selectactype() {
	...
	$resultactyep = mysqli_query($connectAMS,$actypequery);
	//die($actypequery);
	while ($hasilactype = mysqli_fetch_array($resultactyep))
	{
		$arractype[] = $hasilactype[0];
	}//die(print_r($arractype));
	array_push($arractype,"A330","B737-Classic","B737-Classic GA","B737-800-E","B737-800-M","ATR72-600-GA","ATR72-600-QG");
	return $arractype;
}
...
function targetdispatch($type){
	if ($type == "A330-300"){
		...
		$target = 99.60;
	} else if ($type == "ATR72-600-GA"){
		$target = 99.60;
	} else if ($type == "ATR72-600-QG"){
		$target = 99.60;		
	} else if ($type == "B737-Classic"){
		$target = 99.10;	
	} 
	return $target;
}
