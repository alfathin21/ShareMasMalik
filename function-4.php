...
function fleet($time,$actype)
{
	...
	$qryFH = "SELECT DISTINCT Count(`tbl_monthlyfhfc`.`IDReg`) AS `jumlah`, DATE_FORMAT(tbl_monthlyfhfc.MonthEval,'%Y-%m') AS `periode`, `tbl_monthlyfhfc`.`Actype` AS `ACType` FROM `tbl_monthlyfhfc` WHERE `tbl_monthlyfhfc`.`Actype` IN ('".$actype."') AND DATE_FORMAT(`tbl_monthlyfhfc`.`MonthEval`,'%Y-%m') <= '".$time."' GROUP BY DATE_FORMAT(tbl_monthlyfhfc.MonthEval,'%Y-%m') ORDER BY  DATE_FORMAT(tbl_monthlyfhfc.MonthEval,'%Y-%m') DESC LIMIT 12";
...
function available($timeawal,$timeakhir,$actype)
{
	...
	$qryFH = "SELECT Sum(`tbl_monthlyfhfc`.`AvaiDays`) AS `jumlah`, DATE_FORMAT(tbl_monthlyfhfc.MonthEval,'%Y-%m') AS `periode`, `tbl_monthlyfhfc`.`Actype` AS `acType` FROM `tbl_monthlyfhfc` WHERE `tbl_monthlyfhfc`.`Actype` IN ('".$actype."') AND DATE_FORMAT(`tbl_monthlyfhfc`.`MonthEval`,'%Y-%m') BETWEEN '".$timeawal."' AND '".$timeakhir."' GROUP BY  DATE_FORMAT(`tbl_monthlyfhfc`.`MonthEval`,'%Y-%m') ORDER BY DATE_FORMAT(`tbl_monthlyfhfc`.`MonthEval`,'%Y-%m') DESC";
...
function queryFH($time,$actype)
{
	...
	//DIE($time);
	$qryFH = "SELECT Sum(`tbl_monthlyfhfc`.`RevFHHours`) AS `RevFH`, Sum(`tbl_monthlyfhfc`.`RevFHMin`) AS `RevFHMin`, Sum(`tbl_monthlyfhfc`.`NoRevFHHours`) AS `NoRevFH`, Sum(`tbl_monthlyfhfc`.`NoRevFHMin`) AS `NoRevFHMin`, DATE_FORMAT(tbl_monthlyfhfc.MonthEval,'%Y-%m') AS `periode` FROM `tbl_monthlyfhfc` WHERE `tbl_monthlyfhfc`.`Actype` = '".$actype."' AND DATE_FORMAT(`tbl_monthlyfhfc`.`MonthEval`,'%Y-%m') <= '".$time."' GROUP BY`tbl_monthlyfhfc`.`Actype`, DATE_FORMAT(`tbl_monthlyfhfc`.`MonthEval`,'%Y-%m') ORDER BY DATE_FORMAT(`tbl_monthlyfhfc`.`MonthEval`,'%Y-%m') DESC LIMIT 12";
	$resultFH = mysql_query($qryFH);
	//die($qryFH);
	while ($hasilFH = mysql_fetch_array($resultFH))
	{
...
function queryFC($time,$actype)
{
	...
	$qryFH = "SELECT Sum(`tbl_monthlyfhfc`.`RevFHHours`) AS `RevFH`, Sum(`tbl_monthlyfhfc`.`RevFHMin`) AS `RevFHMin`, Sum(`tbl_monthlyfhfc`.`NoRevFHHours`) AS `NoRevFH`, Sum(`tbl_monthlyfhfc`.`NoRevFHMin`) AS `NoRevFHMin`, Sum(`tbl_monthlyfhfc`.`RevFC`) AS `RevFC`, Sum(`tbl_monthlyfhfc`.`NoRevFC`) AS `NoRevFC`, DATE_FORMAT(tbl_monthlyfhfc.MonthEval,'%Y-%m') AS `periode` FROM `tbl_monthlyfhfc` WHERE `tbl_monthlyfhfc`.`Actype` = '".$actype."' AND DATE_FORMAT(`tbl_monthlyfhfc`.`MonthEval`,'%Y-%m') <= '".$time."' GROUP BY `tbl_masterac`.`ACType`, DATE_FORMAT(`tbl_monthlyfhfc`.`MonthEval`,'%Y-%m') ORDER BY DATE_FORMAT(`tbl_monthlyfhfc`.`MonthEval`,'%Y-%m') DESC LIMIT 12";
	$resultFH = mysql_query($qryFH);
	//die($qryFH);
	while ($hasilFH = mysql_fetch_array($resultFH))
	{
...
{
	$qryFH = "SELECT Sum(`tbl_monthlyfhfc`.`RevFHHours`) AS `RevFH`, Sum(`tbl_monthlyfhfc`.`RevFHMin`) AS `RevFHMin`, Sum(`tbl_monthlyfhfc`.`NoRevFHHours`) AS `NoRevFH`, Sum(`tbl_monthlyfhfc`.`NoRevFHMin`) AS `NoRevFHMin`, DATE_FORMAT(tbl_monthlyfhfc.MonthEval,'%Y-%m') AS `periode` FROM `tbl_monthlyfhfc` WHERE `tbl_monthlyfhfc`.`Actype` IN ('".$actype."') AND DATE_FORMAT(`tbl_monthlyfhfc`.`MonthEval`,'%Y-%m') <= '".$time."' GROUP BY DATE_FORMAT(`tbl_monthlyfhfc`.`MonthEval`,'%Y-%m') ORDER BY DATE_FORMAT(`tbl_monthlyfhfc`.`MonthEval`,'%Y-%m') DESC LIMIT ".$limit;
...
{
	$qryFH = "SELECT Sum(`tbl_monthlyfhfc`.`RevFHHours`) AS `RevFH`, Sum(`tbl_monthlyfhfc`.`RevFHMin`) AS `RevFHMin`, Sum(`tbl_monthlyfhfc`.`NoRevFHHours`) AS `NoRevFH`, Sum(`tbl_monthlyfhfc`.`NoRevFHMin`) AS `NoRevFHMin`, Sum(`tbl_monthlyfhfc`.`RevFC`) AS `RevFC`, Sum(`tbl_monthlyfhfc`.`NoRevFC`) AS `NoRevFC`, DATE_FORMAT(tbl_monthlyfhfc.MonthEval,'%Y-%m') AS `periode` FROM `tbl_monthlyfhfc` WHERE `tbl_monthlyfhfc`.`Actype` IN ('".$actype."') AND DATE_FORMAT(`tbl_monthlyfhfc`.`MonthEval`,'%Y-%m') <= '".$time."' GROUP BY  DATE_FORMAT(`tbl_monthlyfhfc`.`MonthEval`,'%Y-%m') ORDER BY DATE_FORMAT(`tbl_monthlyfhfc`.`MonthEval`,'%Y-%m') DESC LIMIT ".$limit;
...
function alert($timeawal,$timeakhir,$actype)//query untuk Alert Level Pilot Report
{
	...
	//die(print_r($bulanan));
	$qryFH = "SELECT Sum(`tbl_monthlyfhfc`.`RevFHHours`) AS `RevFH`, Sum(`tbl_monthlyfhfc`.`RevFHMin`) AS `RevFHMin`, Sum(`tbl_monthlyfhfc`.`NoRevFHHours`) AS `NoRevFH`, Sum(`tbl_monthlyfhfc`.`NoRevFHMin`) AS `NoRevFHMin`, DATE_FORMAT(tbl_monthlyfhfc.MonthEval,'%Y-%m') AS `periode` FROM `tbl_monthlyfhfc` WHERE `tbl_monthlyfhfc`.`Actype` = '".$actype."' AND (DATE_FORMAT(`tbl_monthlyfhfc`.`MonthEval`,'%Y-%m') BETWEEN '".$timeawal."' AND '".$timeakhir."') GROUP BY`tbl_monthlyfhfc`.`Actype`, DATE_FORMAT(`tbl_monthlyfhfc`.`MonthEval`,'%Y-%m') LIMIT 12";
	$resultFH = mysql_query($qryFH);
	//die($qryFH);
	while ($hasilFH = mysql_fetch_array($resultFH))
	{
...
function alertdelay($timeawal,$timeakhir,$actype)//query untuk Alert Level Delay Report
{
	...
	ksort($ATAalert);
	//die(print_r($ATAalert));	
	$qryFH = "SELECT Sum(`tbl_monthlyfhfc`.`RevFHHours`) AS `RevFH`, Sum(`tbl_monthlyfhfc`.`RevFHMin`) AS `RevFHMin`, Sum(`tbl_monthlyfhfc`.`NoRevFHHours`) AS `NoRevFH`, Sum(`tbl_monthlyfhfc`.`NoRevFHMin`) AS `NoRevFHMin`, Sum(`tbl_monthlyfhfc`.`RevFC`) AS `RevFC`, Sum(`tbl_monthlyfhfc`.`NoRevFC`) AS `NoRevFC`, DATE_FORMAT(tbl_monthlyfhfc.MonthEval,'%Y-%m') AS `periode` FROM `tbl_monthlyfhfc` WHERE `tbl_monthlyfhfc`.`Actype` = '".$actype."' AND (DATE_FORMAT(`tbl_monthlyfhfc`.`MonthEval`,'%Y-%m') BETWEEN '".$timeawal."' AND '".$timeakhir."') GROUP BY `tbl_monthlyfhfc`.`Actype`, DATE_FORMAT(`tbl_monthlyfhfc`.`MonthEval`,'%Y-%m') LIMIT 12";
...
{
	$qryFH = "SELECT DATE_FORMAT(tbl_monthlyfhfc.MonthEval,'%Y-%m') AS `periode`, `tbl_monthlyfhfc`.`Actype` AS `ACType`, `tbl_monthlyfhfc`.`Reg` AS `ACReg`, `tbl_monthlyfhfc`.`TSN`, `tbl_monthlyfhfc`.`CSN`, `tbl_monthlyfhfc`.`TSNMin` FROM `tbl_monthlyfhfc` WHERE `tbl_monthlyfhfc`.`Actype` = '".$actype."' AND DATE_FORMAT(tbl_monthlyfhfc.MonthEval,'%Y-%m') <= '".$time."' ORDER BY  DATE_FORMAT(tbl_monthlyfhfc.MonthEval,'%Y-%m') DESC";
	$resultFH = mysql_query($qryFH);
	//die($qryFH);
	while ($hasilFH = mysql_fetch_array($resultFH))
	{
...
{
	$qryFH = "SELECT DATE_FORMAT(tbl_monthlyfhfc.MonthEval,'%Y-%m') AS `periode`, `tbl_monthlyfhfc`.`Actype` AS `ACType`, `tbl_monthlyfhfc`.`Reg` AS `ACReg`, `tbl_monthlyfhfc`.`TSN`, `tbl_monthlyfhfc`.`CSN` FROM `tbl_monthlyfhfc` WHERE `tbl_monthlyfhfc`.`Actype` = '".$actype."' AND DATE_FORMAT(tbl_monthlyfhfc.MonthEval,'%Y-%m') <= '".$time."' ORDER BY  DATE_FORMAT(tbl_monthlyfhfc.MonthEval,'%Y-%m') DESC";
	$resultFH = mysql_query($qryFH);
	//die($qryFH);
	while ($hasilFH = mysql_fetch_array($resultFH))
	{
...
{
	$qryFH = "SELECT DATE_FORMAT(tbl_monthlyfhfc.MonthEval,'%Y-%m') AS `periode`, `tbl_monthlyfhfc`.`Actype` AS `ACType`, `tbl_monthlyfhfc`.`Reg` AS `ACReg`, `tbl_monthlyfhfc`.`TSN`, `tbl_monthlyfhfc`.`CSN`, `tbl_monthlyfhfc`.`RevFHHours`, `tbl_monthlyfhfc`.`RevFHMin`, `tbl_monthlyfhfc`.`RevFC`, `tbl_monthlyfhfc`.`NoRevFHHours`, `tbl_monthlyfhfc`.`NoRevFHMin`, `tbl_monthlyfhfc`.`NoRevFC` FROM `tbl_monthlyfhfc` WHERE `tbl_monthlyfhfc`.`Actype` = '".$actype."' AND (DATE_FORMAT(tbl_monthlyfhfc.MonthEval,'%Y-%m') BETWEEN '".$timeawal."' AND '".$timeakhir."') ORDER BY  DATE_FORMAT(tbl_monthlyfhfc.MonthEval,'%Y-%m') DESC";
	$resultFH = mysql_query($qryFH);
	//die($qryFH);
	while ($hasilFH = mysql_fetch_array($resultFH))
	{
...
{
	$qryFH = "SELECT DISTINCT(`tbl_monthlyfhfc`.`Reg`) AS `ACReg`, `tbl_monthlyfhfc`.`Actype` AS `ACType` FROM tbl_monthlyfhfc Inner Join tbl_masterac ON tbl_monthlyfhfc.IDReg = tbl_masterac.IDreg WHERE tbl_monthlyfhfc.Actype =  '".$actype."' AND tbl_masterac.Active =  '1' ORDER BY `tbl_monthlyfhfc`.`Reg` ASC";
	$resultFH = mysql_query($qryFH);
	//die($qryFH);
	while ($hasilFH = mysql_fetch_array($resultFH))
	{
...
{
	$qryFH = "SELECT DATE_FORMAT(`tbl_engineremove`.`DateRemove`,'%Y-%m') AS periode, Count(tbl_engineremove.ShopVisit) AS jumlah FROM tbl_engineremove WHERE tbl_engineremove.AircraftType IN  ('$actype') AND DATE_FORMAT(tbl_engineremove.DateRemove,'%Y-%m') <=  '$time' AND tbl_engineremove.ShopVisit =  'Shop Visit' GROUP BY tbl_engineremove.ShopVisit, DATE_FORMAT(`tbl_engineremove`.`DateRemove`,'%Y-%m') ORDER BY DATE_FORMAT(`tbl_engineremove`.`DateRemove`,'%Y-%m') DESC";
	$resultFH = mysql_query($qryFH);
	//die($qryFH);
	//while ($hasilFH = mysql_fetch_array($resultFH))
	//{
...
{
	$qryFH = "SELECT DATE_FORMAT(`tbl_engineremove`.`DateRemove`,'%Y-%m') AS periode, Count(tbl_engineremove.ShopVisit) AS jumlah FROM tbl_engineremove WHERE tbl_engineremove.AircraftType IN  ('$actype') AND (DATE_FORMAT(tbl_engineremove.DateRemove,'%Y-%m') BETWEEN  '$timeawal' AND '$timeakhir') AND tbl_engineremove.ShopVisit =  'Shop Visit' GROUP BY tbl_engineremove.ShopVisit, DATE_FORMAT(`tbl_engineremove`.`DateRemove`,'%Y-%m') ORDER BY DATE_FORMAT(`tbl_engineremove`.`DateRemove`,'%Y-%m') DESC";
	$resultFH = mysql_query($qryFH);
	//die($qryFH);
	//while ($hasilFH = mysql_fetch_array($resultFH))
	//{
